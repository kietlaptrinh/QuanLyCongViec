...
public class TaskEdit extends JPanel{
    ...
    TaskEdit(String task, String details, String startdate, String starttime, String enddate, String endtime) throws IOException
    {
        ...
        text_startdate.setText("Ngày bắt đầu");
        ...
        text_enddate.setText("Ngày kết thúc");
        ...
        if (task.equals("Nhập tên công việc")) {
        ...
        text_tasksaved.setText("Đã lưu công việc");
        ...
        text_task_already_exist.setText("Công việc đã tồn tại");
        ...
        text_taskdeleted.setText("Xóa thành công");
