...
public class RegisterPage extends JPanel{
    ...
    RegisterPage() throws IOException
    {
        ...
        text_createaccount.setText("Tạo tài khoản mới");
        ...
        text_takenu.setText("Tên đăng nhập đã được sử dụng");
        ...
        text_registered.setText("Đăng ký thành công");
